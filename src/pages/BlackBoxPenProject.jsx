        ...
        <div className="flex project-page-container" style={{ "--page-accent-color": "rgb(110, 165, 255)" }}>
            <div className="flex flex-col card page-card">
                <div className='prose'>
                    ...
                    <TextSection title="Gaining Access" paragraphs={[
                    ...
                    <TextSection title="Privelege Escalation" paragraphs={[
                    ...
                    <TextSection title="Post-Exploitation" paragraphs={[
                    ...
                    <h2>Common Vulnerability Exploits</h2>
                    <Table
                        colorScale={[0]}
                        center={[0, 1, 2, 3]}
                        widths={["18%", "20%", "22%"]}
