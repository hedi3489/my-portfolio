            ...
            <div className="flex flex-col card page-card">
                <div className='prose'>
                    ...
                    <TextSection className="text-section" title="Privelege Escalation" paragraphs={[
                        ...
                        <>The successful method involved identifying binaries with the SUID bit set — meaning they execute with the permissions of their owner rather than the calling user. Among the SUID-enabled binaries found in /usr/bin, the find command had a documented exploitation path on <b>GTFOBins</b>. By executing a shell through find using the -exec flag, we obtained a root shell without privilege dropping, a key nuance on Debian systems where the -p flag must be omitted. From root, the final flag was recovered.</>]} />
