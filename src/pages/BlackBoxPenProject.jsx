            ...
            <div className="flex flex-col card page-card">
                <div className='prose'>
                    ...
                    <TextSection className="text-section" title="Overview"
                        paragraphs={[
                            <>This report documents the methods and operations involved in conducting a black-box penetration test on a vulnerable Linux virtual machine</>,
                            <>Reconnaissance and enumeration identified critical vulnerabilities in the taget machine's <b>Durpal 7 CMS</b>. With Drupalgeddon exploits, we gained remote shell access, escalated privileges to root via SUID misconfiguration, and demonstrated post-exploitation techniques including persistence, pivoting, and log clearing.</>,<> The engagement concluded with a set of prioritized remediation recommendations targeting the outdated software stack.</>,
                        ]}
                    />
                    <TextSection className="text-section" subtitle="Test Period"
                        paragraphs={[
                            <>The penetration test was performed over 3 weeks starting on April 20, 2025, and ending on May 7, 2025. The target was a black-box virtual machine run in VirtualBox. No restrictions were established."</>
                        ]}
                    />
                    {/* <TextSection className="text-section" title=""> */}

                        <TextSection className="text-section" title="Reconnaissance & Enumeration" paragraphs={[<>Using <b>Nmap</b>, <b>Nikto</b>, and <b>Gobuster</b>, three open ports were identified: SSH(20), HTTP(80), RPC(111) - and identified the target as a Debian Linux machine running an outdated Drupal 7 CMS. Web enumeration revealed sensitive files, and Wappalyzer confirmed the full software stack: Drupal 7, Apache 2.2.22, PHP 5.4.45, and jQuery 1.4.4 — every component of which was outdated and carrying known vulnerabilities.</>]} />
